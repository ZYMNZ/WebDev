  ...
  - **display**
    ...
    ### FLEX-SIZING
      ...
      - Here we have a container that has the display set to flex, so by `default`, the flex-sizing is set to content width unless there's a higher priority that is set. <br>
        ...
        In case the screen is shrunk, each of the items will automatically shrink until they reach the minimum content size. <br><br>
        <img src="https://github.com/ZYMNZ/WebDev/assets/98342638/d880f429-33d7-421c-a4e8-6c780b9c2580" width=500px> <br><br>
      ...
      - Assigning a specific _size_ to the flex-items: <br>
        ...
        - In case we use `flex-basis`(recap: determines the width of each of the items), the `width` will get ignored (again IF there's enough space)<br>
          <img src="https://github.com/ZYMNZ/WebDev/assets/98342638/89bba0e1-f98a-40a3-9045-a8cb80154f58" width=500px> <br>
          > Note: If the screen is shrunk (Phone-Screen), `min-width` will be applied <br>

          <img src="https://github.com/ZYMNZ/WebDev/assets/98342638/59ba476a-0a77-493a-8a82-f819bafe4b00" width=500px> <br>
